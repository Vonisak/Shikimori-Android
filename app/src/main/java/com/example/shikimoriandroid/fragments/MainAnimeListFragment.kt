...
import com.example.shikimoriandroid.adapters.AnimeListAdapter
...
import com.example.shikimoriandroid.viewModels.MainListViewModel
import com.google.android.material.bottomsheet.BottomSheetBehavior
import io.reactivex.rxjava3.schedulers.Schedulers

class MainAnimeListFragment :
    BaseBottomNavFragment(),
    AnimeListAdapter.OnAnimeClickListener,
    ...
    private val adapter = AnimeListAdapter(animeList, glideAdapter, this)
    private var page = 1
    ...
    override fun onAnimeClick(id: Int) {
        Log.i("TAG", "click $id")
